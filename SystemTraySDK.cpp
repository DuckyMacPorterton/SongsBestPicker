                       ...
                       UINT uBalloonTimeout /*=10*/)
{
    ...
    _tcsncpy_s (m_tnd.szTip, szToolTip, m_nMaxTooltipLength);
...
#ifdef _UNICODE
    strBuffer[0] = _T('\0');
//    MultiByteToWideChar (CP_ACP, 0, m_tnd.szTip, -1, strBuffer, m_nMaxTooltipLength);	
	_tcsncpy_s (strBuffer, m_tnd.szTip, m_nMaxTooltipLength-1);
#else
