...
//properties
	...
	BOOL IsOnMonitor( const LPRECT lprc, int nRequireThisManyPixelsToBeOnMonitor = 30) const;

	BOOL GetDistanceFromMonitor (CRect rcWnd, int& rdX, int& rdY);

	BOOL IsCompletelyOnMonitor (const LPRECT lprc) const;
